...
export const GALLERY_PROJECTS = [
    {
        ...
        techStack: ['/textures/gallery/pythonlogo.webp', '/textures/gallery/pytorchlogo.webp', '/textures/gallery/opencvlogo.webp', '/textures/gallery/numpylogo.webp']
    },
    {
        ...
        techStack: ['/textures/gallery/pythonlogo.webp', '/textures/gallery/langchainlogo.webp', '/textures/gallery/ollamalogo.webp', '/textures/gallery/geminilogo.webp']
    },
    {
        id: 'jarvis-os',
        title: 'JARVIS-OS',
        ...
        techStack: ['/textures/gallery/pythonlogo.webp', '/textures/gallery/langchainlogo.webp', '/textures/gallery/geminilogo.webp', '/textures/gallery/ollamalogo.webp']
    }
];
